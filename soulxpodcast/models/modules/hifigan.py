...
class HiFTGenerator(nn.Module):
    ...
    def __init__(
        ...
        upsample_scale_prod = 1
        for rate in upsample_rates:
            upsample_scale_prod *= rate
        ...
        self.m_source = this_SourceModuleHnNSF(
            ...
            upsample_scale=upsample_scale_prod * istft_params["hop_len"],
            harmonic_num=nb_harmonics,
            sine_amp=nsf_alpha,
            add_noise_std=nsf_sigma,
            voiced_threshod=nsf_voiced_threshold)
        self.f0_upsamp = torch.nn.Upsample(scale_factor=upsample_scale_prod * istft_params["hop_len"])
